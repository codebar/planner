  ...
  describe '#find_members' do
    describe 'search by first name' do
      it 'finds the member' do
        expect(described_class.find_members_by_name(member.name).first).to eq(member)
      end
    end

    describe 'search by last name' do
      it 'finds the member' do
        expect(described_class.find_members_by_name(member.surname).first).to eq(member)
      end
    end

    describe 'search by full name' do
      it 'finds the member' do
        expect(described_class.find_members_by_name("#{member.name} #{member.surname}").first).to eq(member)
      end
    end
