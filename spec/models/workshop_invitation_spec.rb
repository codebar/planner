  ...
  context 'with scopes' do
    describe '#attended' do
      it 'ignores when attended nil' do
        ...
        expect(described_class.attended).to eq []
      end
      ...
      it 'selects when attended true' do
        ...
        expect(described_class.attended).to include(invitation)
      end
    end
    ...
    describe '#accepted_or_attended' do
      it 'ignores when attending nil and attended nil' do
        ...
        expect(described_class.accepted_or_attended).to eq []
      end
      ...
      it 'selects when attending false and attended true' do
        ...
        expect(described_class.accepted_or_attended).to include(invitation)
      end
    ...
    describe '#not_reminded' do
      it 'includes invitations without reminders' do
        ...
        expect(described_class.not_reminded).to include(not_reminded)
      end

      it 'excludes invitations with reminders' do
        reminded = Fabricate(:workshop_invitation, reminded_at: 3.hours.ago)

        expect(described_class.not_reminded).not_to include(reminded)
      end
    end
    ...
    it '#on_waiting_list' do
      ...
      expect(described_class.on_waiting_list).to eq(waiting_list)
    end
  end
end
