class ChapterController < ApplicationController
  def show
    ...
    @upcoming_workshops = events.map.inject({}) do |hash, (key, value)|
    ...
    @latest_workshops = past_events.map.inject({}) do |hash, (key, value)|
      hash[key] = EventPresenter.decorate_collection(value); hash
    end
